<ul class="timeline timeline-vertical py-8">
    ...
    <li>
        <hr class="bg-primary" data-aos="fade-down"/>
        <div class="timeline-start timeline-box" data-aos="fade-right">Phone</div>
        <div class="timeline-middle" data-aos="fade-down">
            <x-heroicon-m-check-circle class="w-5 h-5 text-primary" />
        </div>
    ...
    <li>
        <hr class="bg-primary" data-aos="fade-down"/>
        <div class="timeline-start timeline-box" data-aos="fade-right">Ultra widescreen monitor</div>
        <div class="timeline-middle" data-aos="fade-down">
            <x-heroicon-m-check-circle class="w-5 h-5 text-primary" />
        </div>
    </li>
