    ...
    <div class="hero">
        <div class="hero-content flex-col lg:flex-row-reverse">
            <div class="text-center lg:text-left">
                ...
                <p class="py-6">If you find a bug or want to contact me, then write to me at Telegram: @ya_hannes.</p>
            </div>
            <div class="card shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
                <form class="card-body" method="POST" action="{{route('feedback.create')}}">
                    ...
                    @endif
                    @csrf
                    <label class="input input-bordered flex items-center input-primary gap-2">
                    ...
                    <textarea class="textarea textarea-primary" placeholder="Message" id="message" name="message"></textarea>
                    <label class="input input-bordered flex items-center input-primary gap-2">
